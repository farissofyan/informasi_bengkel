						...
						<div class="panel-body">
							...
							<table class="table table-striped table-bordered table-hover" id="tabel-data">
								...
								<tbody>
									...
									$i = 1;
									$grand = 0;
									$sql = "SELECT tmp_trx.*, barangjasa.*, users.* FROM tmp_trx, barangjasa, users WHERE tmp_trx.id_brg=barangjasa.id_brg AND tmp_trx.id_kasir=users.id AND tmp_trx.status='On Process' AND tmp_trx.id_kasir='$kasir' ORDER BY barangjasa.nama ASC";
