...
<body style="background-color: 	#1E90FF">
    ...
    <section id="main-wrapper" style="margin-top: 150px">
                ...
                <div id="page-wrapper" class="col-lg-4 col-lg-offset-4 col-md-4 col-md-offset-4" style="background-color: #ffffff; border-radius: 20px; webkit-box-shadow: 0 1px 1px rgba(0,0,0,0,0.5); box-shadow: 0 1px 1px rgba(0,0,0,0.5)">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <h3 class="text-muted text-center">Register Akun Customer</h3>
                        </div>
                    </div><!-- /.row -->
                    <div class="row">
                        <div class="col-lg-12">
    ...
    <div class="navbar navbar-inverse navbar-fixed-bottom footer-bottom">
        <div class="container text-center">
            <p class="text-center" style="color: #D1C4E9; margin: 0 0 5px; padding: 0"><small>&copy; Sistem Informasi Media Workshop</small></p>
        </div>
    </div><!-- /.footer-bottom -->
