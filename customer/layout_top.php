			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						?>
						<!-- <?php
						if ($pagedesc == "Cek Booking") {
							echo '<li><a href="trx_cek.php" class="active"><i class="fa fa-home fa-fw"></i>&nbsp;Cek Booking</a></li>';
						} else {
							echo '<li><a href="trx_cek.php"><i class="fa fa-home fa-fw"></i>&nbsp;Cek Booking</a></li>';
						}
						if (isset($menuparent) && $menuparent == "transaksi") {
							echo '<li class="active">';
						} else {
						...
						<a href="#"><i class="fa fa-shopping-cart fa-fw"></i>&nbsp;Booking<span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<?php
							if ($pagedesc == "Pesan Jasa") {
								echo '<li><a href="trx_baru.php" class="active">Pesan Jasa</a></li>';
							} else {
								echo '<li><a href="trx_baru.php">Booking Service</a></li>';
							}
							?>
							<?php
							...
							if ($pagedesc == "Cek Booking") {
								echo '<li><a href="trx_cek.php" class="active">Cek Booking</a></li>';
							} else {
								echo '<li><a href="trx_cek.php">Cek Booking</a></li>';
							}
								?>
						</ul><!-- /.nav-second-level -->
						</li>
